  INSERT INTO [VENDAS_SUCOS].[DBO].[PRODUTOS] ([CODIGO],[DESCRITOR],[SABOR],[TAMANHO],[EMBALAGEM],[PREÇO LISTA]) VALUES 
	 ...
	 SELECT * FROM [VENDAS_SUCOS].[DBO].[PRODUTOS] WHERE SUBSTRING([DESCRITOR],1,15) = 'Sabor dos Alpes'
